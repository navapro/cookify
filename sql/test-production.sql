...
SELECT User_ID FROM Users WHERE Email = 'mary.doe@email.com';

-- -- 2. Insert new user profile
INSERT INTO Users (Name, Email, Password, Cookify_Level) 
VALUES ('John Doe', 'mary.doe@email.com', '$2b$12$hashed_password_example', '1');

-- 3. Verify user was created successfully
SELECT User_ID, Name, Email, Cookify_Level 
FROM Users 
WHERE Email = 'mary.doe@email.com';
...
SELECT User_ID, Name, Email, Cookify_Level FROM Users ORDER BY Name DESC; 
...
INSERT INTO CookList_Recipes (CookList_ID, Recipe_ID) VALUES (8, 3070);
INSERT INTO CookList_Recipes (CookList_ID, Recipe_ID) VALUES (8, 3071);
...
('Wayne Ju', 'w4ju@uwaterloo.ca', '$2b$10$hashedpassword1', '2005-09-11', 45, '100');
...
INSERT INTO Recipes (Recipe_ID, User_ID, Name, Duration, Difficulty, Cuisine, Instructions, Image_URL) VALUES
(14000, 1, 'Rosemary Focaccia', 120, 'Medium', 'Italian', 'cook good. good cook.', 'very real link'),
(14001, 1, 'Tamagoyaki', 15, 'Medium', 'Japanese', 'also cook good. please.', 'slightly real link'),
(14002, 2, 'Okonomiyaki', 30, 'Medium', 'Japanese', 'cook good (optional)', 'very fake link'),
(14003, 3, 'Fried Rice', 15, 'Easy', 'Chinese', 'a (blank) fried this rice!?!?!?', 'very real link'),
(14004, 4, 'Croissants', 300, 'Hard', 'French', 'hon hon hon', 'very real link');
...
SELECT * FROM Recipe_Likes WHERE User_ID = 2;

-- viewing recipes in Liked Recipes cooklist
SELECT * FROM Recipes r WHERE EXISTS (SELECT Recipe_ID FROM Cooklist_Recipes WHERE Cooklist_ID = (SELECT Cooklist_ID FROM Cooklists WHERE User_ID = '2' AND Name = 'Liked Recipes') AND Recipe_ID = r.Recipe_ID);
